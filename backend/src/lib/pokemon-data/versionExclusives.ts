...
const RAW_CURATED_EXCLUSIVES: Record<number, VersionSpeciesMap> = {
  ...
  3: {
    ...
    emerald: ["seedot", "nuzleaf", "shiftry", "mawile", "zangoose", "solrock", "lotad", "lombre", "ludicolo", "sableye", "seviper", "lunatone", "groudon", "kyogre"],
  },
  4: {
    diamond: ["caterpie", "metapod", "butterfree", "ekans", "arbok", "growlithe", "arcanine", "seel", "dewgong", "scyther", "scizor", "murkrow", "honchkrow", "gligar", "gliscor", "kecleon", "cranidos", "rampardos", "stunky", "skuntank", "dialga"],
    pearl: ["weedle", "kakuna", "beedrill", "sandshrew", "sandslash", "vulpix", "ninetales", "slowpoke", "slowbro", "slowking", "pinsir", "misdreavus", "mismagius", "bagon", "shelgon", "salamence", "shieldon", "bastiodon", "glameow", "purugly", "palkia"],
    platinum: ["caterpie", "metapod", "butterfree", "ekans", "arbok", "growlithe", "arcanine", "seel", "dewgong", "scyther", "scizor", "murkrow", "honchkrow", "gligar", "gliscor", "kecleon", "cranidos", "rampardos", "stunky", "skuntank", "weedle", "kakuna", "beedrill", "sandshrew", "sandslash", "vulpix", "ninetales", "slowpoke", "slowbro", "slowking", "pinsir", "misdreavus", "mismagius", "bagon", "shelgon", "salamence", "shieldon", "bastiodon", "glameow", "purugly", "dialga", "palkia"],
  },
  5: {
    black: ["cottonee", "whimsicott", "scraggy", "scrafty", "gothita", "gothorita", "gothitelle", "rufflet", "braviary", "tornadus", "reshiram"],
    white: ["petilil", "lilligant", "croagunk", "toxicroak", "solosis", "duosion", "reuniclus", "vullaby", "mandibuzz", "thundurus", "zekrom"],
  },
  6: {
  ...
  12: {
    firered: ["ekans", "arbok", "oddish", "gloom", "vileplume", "psyduck", "golduck", "growlithe", "arcanine", "shellder", "cloyster", "scyther", "electabuzz", "wooper", "quagsire"],
    leafgreen: ["sandshrew", "sandslash", "vulpix", "ninetales", "meowth", "persian", "bellsprout", "weepinbell", "victreebel", "slowpoke", "slowbro", "magmar", "pinsir", "misdreavus"],
  },
  13: {
    heartgold: ["mankey", "primeape", "growlithe", "arcanine", "spinarak", "ariados", "gligar", "gliscor", "teddiursa", "ursaring", "phanpy", "donphan", "mantine"],
    soulsilver: ["meowth", "persian", "vulpix", "ninetales", "ledyba", "ledian", "delibird", "skarmory", "sableye", "misdreavus", "mismagius", "stantler"],
  },
  14: {
    "lets-go-pikachu": ["oddish", "gloom", "vileplume", "sandshrew", "sandslash", "growlithe", "arcanine", "grimer", "muk", "scyther", "mankey", "primeape"],
    "lets-go-eevee": ["bellsprout", "weepinbell", "victreebel", "vulpix", "ninetales", "meowth", "persian", "ekans", "arbok", "koffing", "weezing", "pinsir"],
  },
};
