...
export default function AdminSettingsPage() {
  ...
  const canAccessAdmin = viewer?.role === "ADMIN" || viewer?.role === "OWNER";
    ...
    return (
      <main className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
        <div className="panel p-6">
          ...
          <Link href="/settings" className="btn-secondary mt-4 inline-flex items-center gap-2">
            <FiArrowLeft size={14} />
            Back to settings
          </Link>
        </div>
