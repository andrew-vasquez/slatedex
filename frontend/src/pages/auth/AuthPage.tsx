...
function AuthPageContent() {
  ...
  function switchTab(next: Tab) {
    ...
    void navigate({ to: params.toString() ? `/auth?${params.toString()}` : "/auth", replace: true });
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12" style={{ background: "var(--bg-gradient)" }}>
      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <Link to="/" className="font-display text-3xl leading-none" style={{ letterSpacing: "-0.025em", textDecoration: "none" }}>
        ...
        <p className="mt-6 text-center text-xs leading-relaxed" style={{ color: "var(--text-muted)" }}>
          ...
          <Link to="/terms" style={{ color: "var(--text-secondary)", textDecoration: "underline", textUnderlineOffset: "2px" }}>
            Terms
          </Link>
          {" "}and{" "}
          <Link to="/privacy" style={{ color: "var(--text-secondary)", textDecoration: "underline", textUnderlineOffset: "2px" }}>
            Privacy Policy
          </Link>
          .
        </p>
