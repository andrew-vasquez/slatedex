  ...
  if (isAuthenticated) {
    return (
      <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
        <AppLink href="/play" className="landing-cta-primary inline-flex items-center gap-2 rounded-2xl px-6 py-3 text-sm font-semibold sm:text-base">
          Start Building
          <FiArrowRight size={15} aria-hidden="true" />
        </AppLink>
        <AppLink href="/teams" className="landing-cta-secondary inline-flex items-center gap-2 rounded-2xl border px-6 py-3 text-sm font-semibold sm:text-base">
        ...
        <div className="mx-auto max-w-screen-md px-4 sm:px-6">
          <div className="panel relative overflow-hidden px-6 py-8 text-center sm:px-12">
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
              <AppLink href="/play" className="landing-cta-primary inline-flex items-center gap-2 rounded-2xl px-5 py-2.5 text-sm font-semibold">
                Launch Builder <FiArrowRight size={14} aria-hidden="true" />
              </AppLink>
              <AppLink href="/teams" className="landing-cta-secondary inline-flex items-center gap-2 rounded-2xl border px-5 py-2.5 text-sm font-semibold">
