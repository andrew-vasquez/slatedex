...
const AvatarPickerModal = ({
  ...
  return (
    <div className="fixed inset-0 z-[98] flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="avatar-picker-title">
      <button
        type="button"
        onClick={onClose}
      ...
      <section className="panel relative w-full max-w-3xl p-4 sm:p-5 animate-scale-in">
