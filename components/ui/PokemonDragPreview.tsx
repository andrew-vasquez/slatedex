  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: "0 20px 40px rgba(40, 28, 18, 0.25), 0 0 24px rgba(218, 44, 67, 0.16)",
      }}
    >
      <div className="flex items-center gap-3 p-3">
        <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg" style={{ background: "var(--surface-2)", border: "1px solid var(--border)" }}>
          <Image src={pokemon.sprite} alt={pokemon.name} width={40} height={40} className="h-10 w-10 object-contain drop-shadow-lg" priority />
        </div>
        <div>
