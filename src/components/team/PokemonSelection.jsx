...
const PokemonSelection = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-3 sm:gap-4 max-h-[50vh] sm:max-h-[calc(100vh-350px)] overflow-y-auto pr-1 sm:pr-2 custom-scrollbar"
        role="grid"
